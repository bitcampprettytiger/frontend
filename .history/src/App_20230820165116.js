...
import SellStoreSet from './path-to-SellStoreSet';
import SellHome from './path-to-SellHome';
import SellMySet from './path-to-SellMySet';
import SellFooter from './path-to-SellFooter';
        ...
        <MobileView className='MV'>
          <div className="App wrapper">
            <div className="App-main">
              <Routes>
                {/* Assuming similar routes for mobile, can be adjusted */}
                <Route path="/home" element={<Home />} />
                {/* ... other routes */}
              </Routes>
            </div>
