...
function SellFooter() {
  ...
  return (
    <AppBar position="static" sx={{ top: 'auto', bottom: 0, background: '#ffffff', borderTop: '1px solid #e7e7e7' }}>
      <Toolbar sx={{ justifyContent: 'space-around', alignItems: 'center' }}>
        <IconButton color={activeButton === 'streetFood' ? 'primary' : 'default'} onClick={() => handleButtonClick('streetFood')}>
          <img
        ...
        <IconButton color={activeButton === 'home' ? 'primary' : 'default'} onClick={() => handleButtonClick('home')}>
          <img
        ...
        <IconButton color={activeButton === 'myPage' ? 'primary' : 'default'} onClick={() => handleButtonClick('myPage')}>
          <img
